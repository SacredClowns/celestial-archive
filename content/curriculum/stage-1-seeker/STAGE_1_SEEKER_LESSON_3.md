...
# Lesson 1.3 — The First Transmissions
...
|:---|:---|
| **Rank** | Seeker (Stage 1) |
| **Position** | Lesson 3 of 5 in the Seeker path |
| **Estimated duration** | 55–70 minutes (reading + reflection) |
| **Emotional register** | Curiosity → tension → fascination → ambiguity |
| **Philosophical posture** | Intellectual honesty; disciplined wonder; discernment before belief |
| **New glossary terms introduced** | Shew-Stone · Holy Table · Sigillum Dei Aemeth · Heptarchic · Angelic Language |
| **New badge introduced** | **◎** Parallel — a claim that another tradition or source displays the same structure, without implying causal descent |
| **Prerequisite** | Lesson 1.2 — The Partnership |
| **Leads to** | Lesson 1.4 — The Enochian Language Emerges |
| **Source anchor** | Sloane MS 3188, *Mysteriorum Liber Primus* (fols. 1–15), *Liber Secundus*, *Tertius*, British Library; Peterson 2003 critical edition |
...
1. Describe the physical, liturgical, and dispositional apparatus of a scrying session at Mortlake in 1582.
2. Articulate the problem of the single witness and its consequences for every claim about the sessions that follows.
3. Name the first early entities and situate them within Dee's theological expectation.
4. Hold five distinct interpretive lenses (Historical, Traditional Occult, Psychological, Symbolic, Speculative) on the same early transmissions without collapsing them into one.
5. Read the new **◎** Parallel badge and distinguish it from **○** Traditional Occult Claim and **△** Later Interpretation.
6. Begin to feel — not merely to know — why these first sessions continue to unsettle readers four hundred and forty years later.
...
The table has been prepared. It is wood, inscribed with names. Beneath it, supporting its legs, rests a large wax disc nearly nine inches across — the **Sigillum Dei Aemeth**, the *Seal of the Truth of God*, whose design the angels have been dictating and refining over the preceding weeks. ◆ At the center of the table rests the shew-stone. ◆
...
Then Kelley speaks. His voice is low. He reports what he sees and what he hears. ◆
...
**◎ — Parallel.** A claim that a structure or motif in the Dee–Kelley material has a demonstrable precedent or counterpart in another tradition or source. The **◎** badge asserts *structural similarity*. It does **not** assert causal descent, conscious borrowing, or metaphysical identity. When the Archive marks something **◎**, it is saying: *this pattern exists elsewhere too; you may find the resemblance informative; we are not yet telling you what the resemblance means.*

You will see **◎** first around the Sigillum Dei Aemeth — whose design has clear medieval precedents in the *Liber Juratus* tradition and in Sloane MS 313 — and later around the structure of angelic hierarchies that resembles earlier Solomonic and theurgic schemes.

**◎** is not a weaker **◆**. It is a different kind of claim entirely. A parallel is a piece of evidence about the *landscape*, not about the individual object.
...
At the center of the Holy Table sat a small polished stone or crystal — the **shew-stone**. ◆ Multiple stones are referenced in the diaries across the years; the sessions of 1582 used at least one such object, most likely the small rock crystal sphere now held in the British Museum. ◆ (*The crystal is British Museum museum number SLCups.232, within the John Dee object group; the case does not constitute unbroken provenance from Dee's hand, but the traditional identification is the strongest available.*)
...
The **Holy Table** was a wooden table with specific dimensions and specific inscriptions. ◆ Its design was not inherited; it was dictated, session by session, by the entities that spoke through Kelley. The angels gave measurements, names to be written along the edges, the arrangement of the characters, and specific corrections when Dee or Kelley drew it incorrectly. The Archive possesses Dee's diagrams; it does not possess the table itself. ◆ Modern reconstructions are drawn from those diagrams, not from a surviving physical object.

### The Sigillum Dei Aemeth

Beneath the Holy Table, supporting its four legs on four smaller wax discs, sat the **Sigillum Dei Aemeth** — the *Seal of the Truth of God.* ◆ A wax disc nearly nine inches across, inscribed with two concentric circles enclosing a pentagram, three heptagons, and a dense apparatus of Hebrew and Latin divine names.

The Sigillum is the first place in the Dee–Kelley record where the new badge applies.

**◎** The design of the Sigillum Dei Aemeth has medieval antecedents. It is structurally related to designs preserved in the *Liber Juratus Honorii* (the *Sworn Book of Honorius*, 13th–14th c.) and in Sloane MS 313, a manuscript Dee is known to have consulted. ◆ Dee already possessed a version of the Sigillum before the sessions with Kelley began.

What happened in the early Kelley sessions is therefore not the *introduction* of the Sigillum but a dictated *refinement* of it — corrections, reordering, and, as Dee recorded, a clarification of what the medieval tradition had received in partial form. ◆ The angels themselves, as reported by Kelley, framed their dictation in this way: not as a new revelation but as the repair of an inherited one.
...
**Kelley alone saw and heard what the sessions produced. Dee saw and heard only what Kelley reported.** ◆

Dee was present. Dee prayed. Dee asked questions. Dee wrote. But the phenomenon itself — the visions in the stone, the figures, the voices, the dictated letters and tables — happened inside Edward Kelley's perception and nowhere else. ◆
...
The earliest Kelley sessions did not open with grand revelations. They opened with disjointed visions, brief appearances of figures Kelley described as small children, angels, or luminous beings; with names half-given; with short declarations; with long stretches of Kelley describing shapes and movements within the stone that did not cohere into system. ◆

One of the earliest entities named — within the first handful of sessions — was **Annael**, whom Dee already recognized from his reading as an angel of Venus in the traditional angelological scheme. ◆ Uriel, Michael, and other figures whose names Dee knew from scripture and tradition also appeared early. ◆
...
Within a few weeks of Kelley's arrival, the material began to *organize itself*. Names began to cluster. Instructions about equipment (the Holy Table, the Sigillum, the position of the stone) became specific. Diagrams began to be dictated. Groupings of angels arranged by number — first by seven, then by multiples of seven — began to appear. ◆
...
**Emotional intensity.** The sessions were long, candlelit, silent, prayer-framed. They took place after fasting, in the late evening, in isolation. Such conditions are known to heighten emotional salience and to produce experiences that feel significant regardless of their objective status. △ This is not a debunking claim. It is a description of the neurology of ritual attention.

**Symbolic coherence.** The material that emerged — the Sigillum, the Holy Table, the early angelic hierarchies — resonated with Dee's existing theological expectations. It fit. It connected the medieval material in his library with a living voice. For a scholar of Dee's depth, this coherence would have been profound evidence of its own kind. ◇

**Ritual focus.** Prayer, fasting, and repeated liturgical framing produce sustained concentrated attention. A man who has been quietly saying specific Latin prayers for an hour is not in the same cognitive state as a man who has not. This is observable even without any metaphysical commitment. ◆

**Altered state.** Whether Kelley entered a trance, a hypnagogic state, a trained dissociative condition, or something else, the accounts in the diaries are consistent with a man perceiving in a non-ordinary mode. ~ The degree and nature of the altered state is contested — see *Who Says This?* below — but some alteration of ordinary perception is hard to read out of the record.

**Performance.** One possibility, long raised by sceptical readers, is that Kelley was performing — that the sessions were conscious fabrication for patronage and access. Internal evidence makes this reading harder to sustain in its strong form (see Lesson 1.2's *Irreducible Mixture* frame), but it cannot be eliminated for every session or every detail. △

**Genuine experience.** Another possibility, held within the tradition, is that something real was encountered — that the filter of prayer and preparation actually worked and a true contact occurred. ○

**The human tendency to create meaning.** Perhaps the most important factor. Human cognition is relentlessly meaning-making. Given fragmentary material, a prepared mind, a framing theology, a question, and a trusted collaborator, meaning will emerge. This is not a pathology. It is how we know anything at all. It is also, therefore, not by itself evidence that what emerged has an external referent. ◇
...
A hierarchy of seven princes, associated with the seven days of the week, was being named. Each prince had a retinue. Names began to repeat. Sigils were being dictated — small geometric marks meant to accompany each name. A body of material called by later scholars the **Heptarchia Mystica** — the *Mystical Sevenfold Kingdom* — was emerging. ◆
...
- The dates and participants of the sessions are known with high precision. ◆ Sloane MS 3188, *Liber Primus* (fols. 1–15) covers December 1581 – March 1582; *Liber Secundus* and subsequent books continue the record.
- The physical apparatus is described, diagrammed, and partly survives in the British Museum — obsidian mirror (1966,1001.1), wax seals (1838,1232.90, letter-suffixed), crystal (SLCups.232), and gold disc (1942,0506.1). ◆
- The Sigillum Dei Aemeth has documented medieval precedents in the *Liber Juratus* tradition and Sloane MS 313. **◎**
- Dee's ritual apparatus — prayer, fasting, moral preparation — is consistent with late-Renaissance Christian theurgic practice. ◇
- The earliest Kelley sessions used names (Annael, Uriel, Michael) that Dee already recognized from traditional angelology. ◆
- The transmissions became rapidly more structured over the first several months of 1582. ◆
...
Within the tradition, the first transmissions are understood as genuine angelic contact. The ritual apparatus worked. The prayers were answered. The sessions produced, over weeks and months, a coherent body of material whose coherence is itself evidence of its authenticity. ○

The tradition reads the Sigillum's medieval precedents not as evidence that the material was recycled, but as evidence that the medieval tradition had received, in partial and corrupted form, a revelation the Dee–Kelley sessions were now restoring to completeness. ○
...
Something — some patterned intelligence, some intelligible order, some informational presence whose source cannot be specified in the vocabulary of either theology or neuroscience as currently understood. ~
...
| **Spontaneous** | The state arose from the intensity of the ritual situation itself. Kelley was not deliberately inducing anything; the conditions produced the experience. | Some traditional-occult readings; some psychological readers who emphasize the ritual environment over individual skill | ? |
| **No altered state** | The sessions were entirely ordinary perception; Kelley simply described what he believed or wished to describe. | A minority sceptical position; Casaubon 1659's framing points this way | ? |
| **Unresolved** | The diaries do not give enough physiological or behavioral detail to settle the question. Kelley did not write an introspective account. Dee's descriptions of Kelley during sessions are partial. | Conservative modern scholarship | ? |
...
| **Systematic from the beginning** | The system was present from the first sessions; what appears as fragmentation is merely the reader's inability to see the whole from a single session. | Some traditional-occult readings that emphasize divine completeness | ? |
| **Constructed, not revealed** | What looks like crystallization is Dee and Kelley progressively organizing their own material; the "system" was assembled, not received. | Sceptical psychological and historical readings | ? |
...
But the upper-left and upper-right quadrants are both compatible with the evidence. The question the Archive holds open is: *how much of the record is upper-left, and how much is upper-right?*
...
**1.** Imagine yourself as Dee, sitting with your pen, listening to someone else describe what you cannot see. What would you need to hear from Kelley to begin to trust the report? What would you need to hear to doubt it?

**2.** You have almost certainly, at some point, been the single witness to something difficult to describe — a dream, a grief, an intuition, a moment of meaning. When you reported it to another person, what was lost, added, or changed? What does this teach you about how you should read a single-witness record from 1582?

**3.** The ritual apparatus of the Mortlake sessions — prayer, fasting, the Holy Table, the Sigillum — was a *filter*, in Dee's theology, meant to exclude false voices and admit true ones. Consider something in your own life that serves as a filter for what you will let in. What is that filter protecting you from? What might it also be excluding?

**4.** The Sigillum Dei Aemeth has medieval precedents. The angels, on Dee's reading, were refining something already partially present in the tradition. Have you ever had an experience that felt new, only to later discover it had been described by someone else long before? What does that layering tell you about the nature of revelation — whether divine, artistic, or personal?

**5.** The Psychological Lens and the Symbolic Lens agree on much of what happened in the sessions but diverge on *what the material is for*. Which of these readings feels closer to your own orientation? Is that preference a considered one, or inherited?

**6.** Kelley reported voices; Dee wrote. The Archive is their joint product, not either one's alone. What collaborations in your own life have produced records that neither participant could have produced alone? What was the nature of the third thing that emerged between you?

**7.** The early voices said names Dee already knew. If something in you were to speak — in a dream, in a sudden insight, in a moment of grief — do you imagine it would use words you already know, or words you do not yet know? What does that imagined answer reveal about your model of where meaning comes from?

**8.** At the end of the first months of sessions, both Dee and Kelley were changed. Consider: what practices in your own life change you? Does that change depend on the practice being "true" in some external sense, or does the change occur regardless?
...
**1. What was the primary function of the Sigillum Dei Aemeth in the Dee–Kelley sessions?**
...
**2. Who, according to the primary record, actually saw and heard what occurred in the shew-stone?**
...
**3. What new badge is introduced in this lesson?**
- A) ⚠ Caution
- B) ◎ Parallel ✓
- C) ✦ Irreducible Question
- D) ♁ Material Artifact

*The **◎** badge marks a structure whose counterpart exists in another tradition without implying causal descent. Its first major use is around the Sigillum Dei Aemeth and its medieval precedents.*

**4. Which of the following names appeared in the earliest Kelley sessions?**
- A) Choronzon
- B) Aiwass
- C) Annael ✓
- D) Baphomet
...
**5. What is the central distinction the Discernment Practice asks the seeker to hold?**
...
**1.** What does it mean for an archive to be built on *mediated testimony*? What other archives in human history share this structure? Do they tend to be weaker or stronger for it?

**2.** The Symbolic Lens reads the transmissions as pattern, regardless of origin. Does this lens *dignify* the material or *diminish* it? Argue either way.

**3.** Dee's theology held that prayer, fasting, and moral cleanliness *filtered* what came through. Is a filter of this kind possible in principle, or does the notion of a filter presuppose what it is meant to detect?
...
**Reading the ◎ Parallel badge.** The seeker now recognizes the difference between a claim of identity, a claim of descent, and a claim of structural parallel. This is a durable analytical distinction that will carry through every remaining stage of the curriculum.
...
|:---|:---|:---|
| **Hero image** | A long shot of the Mortlake chamber: the Holy Table from across the room, one candle at the edge of frame, the shew-stone catching a single point of light. No figures visible. The moment before the sitting. | Opening Sequence |
| **The Sigillum Dei Aemeth** | A high-resolution rendering of the wax disc, with the *Liber Juratus* medieval precedent shown at reduced size beside it. Not superimposed — placed next to, so the eye can read the **◎** relationship. | Section I |
| **The single-witness diagram** | A minimalist illustration: two figures at the Holy Table, the stone between them, a dashed line from Kelley's eyes to the stone, a solid line from Kelley's mouth to Dee's ear, a line from Dee's hand to the page. The geometry of mediation made visible. | Section II |
| **Manuscript page** | A reproduction of a page from Sloane MS 3188 showing an early session entry — the Latin, the angelic names, the marginalia. The collaborative document in its own handwriting. | Section III |
| **The Heptarchic threshold** | A stylized diagram of seven empty chairs arranged around a table — the structure named but not populated. A visual promise of Stage 2. | Section V |
| **The ◎ badge introduction** | A single focused frame: the **◎** glyph in gold on a dark background, with its definition beneath. Meant to be remembered. | Badge introduction note |

### Audio Atmosphere

| Moment | Sound |
|:---|:---|
| **Entering the lesson** | Quieter than Lesson 1.2. The room tone now feels *deliberate*. The candle crackle is closer. Distant church bell, once, very far. |
| **Opening Sequence** | Long silence before the first spoken line. A page turning. The scratch of a quill. |
| **Section I — The Apparatus** | The slow weight of objects being placed. Wood on wood. Wax set down. |
| **Section II — The Single Witness** | A silence held slightly too long. One breath heard. |
| **Section III — The First Words** | Whispered voice at the edge of hearing. Cannot quite be resolved into words. Comes and goes. |
| **Section IV — Why They Felt Convincing** | Sustained low tone. The seeker feels the emotional weight of the sessions without being told to. |
| **Section V — The Edge of a System** | The first suggestion of a recurring numerical motif in the sound bed — seven soft bells, seven heartbeats. Named structurally. |
| **Lens Sections** | Each lens gets a distinct acoustic signature — a filter on the same underlying room tone. The material does not change; the listening position does. |
| **Discernment Practice** | Back to silence. The reader is alone with the decision. |
| **Closing Passage** | The candle, steady. The voice, gone. The pen, down. |

### Relationship Chain

One new chain is added to the Archive's web in this lesson:

> **Prayer → Silence → Gaze → The Stone → The Vision → Kelley's Report → Dee's Pen → The First Names → The Beginning of the Architecture**

This chain sits alongside the Lesson 1.2 chain (*Dee's Question → Kelley's Gaze → The Stone → The Voice Kelley Reported → Dee's Pen → The Archive*). The two chains intersect at *The Stone* and at *Dee's Pen*. The seeker can now see the web beginning to form.

### Sidebar Manifest

The Knowledge Web sidebar for this lesson carries:

- **Glossary terms:** Shew-Stone · Holy Table · Sigillum Dei Aemeth · Heptarchic · Angelic Language · Mediated Testimony · Scrying (from Lesson 1.1)
- **Related figures:** John Dee · Edward Kelley · Annael (first appearance) · Uriel (first appearance) · Michael (first appearance) · Barnabas Saul (in retrospect — the predecessor who did not hear what Kelley heard)
- **Related texts:** Sloane MS 3188 (*Mysteriorum Libri Quinti*); *Liber Juratus Honorii* (precedent for Sigillum); Sloane MS 313; Harkness 1999; Peterson 2003
- **Related symbols:** The Sigillum Dei Aemeth · The Holy Table inscriptions · The shew-stone
- **Related lessons:** 1.1 (Introduction) · 1.2 (The Partnership) · 1.4 (The Language) · 2.1 (The Heptarchic System, at rank unlock)
- **Timeline anchors:** March 1582 (Kelley's arrival) · Spring 1582 (first structured transmissions) · Summer 1582 (Heptarchic material crystallizing)
- **Related questions:** What is a filter? · What is mediated testimony? · Why does sincerity not imply accuracy? · What does **◎** mean and how does it differ from **○** and **△**?
- **Shadow items:** The Forty-Nine Good Angels · The Language Before Babel

### Source Anchors

All citations in this lesson are traceable to the **Approved Citation List** established in the Source Pack 2 Verification Pass (see `SOURCE_PACK_2_VERIFICATION_PASS.md`). Primary anchors for Lesson 1.3 specifically:

- Sloane MS 3188, *Mysteriorum Libri Primus* (fols. 1–15) and subsequent books — for session dates, content, and apparatus
- Peterson, *John Dee's Five Books of Mystery* (2003) — as the working critical edition
- Harkness, *John Dee's Conversations with Angels* (1999) — for the intellectual-historical framing
- Asprem, *Arguing with Angels* (2012) — for the philosophical-critical framing of scrying practice
- British Museum object group — Sigillum Dei Aemeth (1838,1232.90 with letter suffixes); crystal shew-stone (SLCups.232); obsidian mirror (1966,1001.1); gold disc (1942,0506.1)
- *Liber Juratus Honorii* and Sloane MS 313 — for the medieval precedents invoked by the ◎ badge

### Timeline Links

This lesson populates the following timeline anchors:

- **Era 3 → 1582 → March** — Kelley's arrival; first Kelley sessions; earliest named entities
- **Era 3 → 1582 → Spring** — The Sigillum's dictated refinement; the Holy Table's dictated design
- **Era 3 → 1582 → Summer** — The Heptarchic material begins to crystallize; the threshold to the language approaches
...
*Medieval precedents invoked by the ◎ badge*
